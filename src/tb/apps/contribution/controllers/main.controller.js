define(
    [
        'Core',
        'contribution.view.index',
        'jquery',
        'content.widget.DialogAddToMediaLibrary'
    ],
    function (Core, IndexView, jQuery, AddToMediaLibraryWidget) {
        ...
        Core.ControllerManager.registerController('MainController', {
            ...
            indexService: function () {
                ...
                if (this.viewIsLoaded !== true) {
                    AddToMediaLibraryWidget.getInstance().init();
