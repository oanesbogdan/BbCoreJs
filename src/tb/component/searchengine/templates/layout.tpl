<div class="row search-engine">
    <div class="col-bb5-x">
        ...
        <div class="row form-group">
            {% if showFieldStatus %}
                <div class="col-bb5-x">{{ 'status'|trans }} : </div>
                <div class="col-bb5-24">
                    <span class="select select-block">
                        <select data-fieldName="pageStatus" class="form-control content-status">
                            <option value="all">{{ 'all'|trans }}</option>
                            <option value="all_inactive">{{ 'state-0'|trans }}</option>
                            <option value="all_active">{{ 'state-1'|trans }}</option>
                        </select>
                    </span>
                </div>
            {% endif %}
