<div class="row search-engine">
  <div class="col-bb5-x">
    ...
    <div class="row form-group">
      ...
      <div class="col-bb5-22"><div class="input-group input-group-xs"><input type="text" class="form-control disabled input-xs after-date bb5-datepicker" placeholder="dd/mm/aaaa"><span class="input-group-btn"><button class="btn btn-default show-calendar" type="button"><i class="fa fa-calendar"></i></button></span></div></div>
      <div class="col-bb5-x pull-right"><button class="btn btn-default btn-xs search-btn" type="button"><i class="fa fa-search"></i> Search</button></div>
    </div>
  </div>
</div>